...
public class Utility {
    ...
    /**
     * 解析从服务器返回的JSON数据，并将解析出来的数据存储到本地
     */
    public static void handleWeatherResponse(Context context,String response){
        try {
            ...
            savaWeatherResponses(context,cityName,weatherCode,temp1,temp2,weatherDesp,publishTime);
     ...
     */
    public static void savaWeatherResponses(Context context,String cityName,
